...
migrate((app) => {
  ...
  const collection = new Collection({
    ...
    "id": "pbc_8405540527",
    "indexes": [],
    "listRule": "property_id.landlord_id = @request.auth.id || @request.auth.role = \"manager\"",
    "name": "units",
    "system": false,
    "type": "base",
    "updateRule": "property_id.landlord_id = @request.auth.id || @request.auth.role = \"manager\"",
    "viewRule": "property_id.landlord_id = @request.auth.id || @request.auth.role = \"manager\""
  });
  ...
  try {
    const collection = app.findCollectionByNameOrId("pbc_8405540527");
