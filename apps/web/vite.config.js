...
/** Set VITE_DISABLE_CURSOR_DEV_PLUGINS=1 to skip inline-edit / edit-mode / selection-mode (fixes nav in some previews). */
const skipCursorUiPlugins =
	process.env.VITE_DISABLE_CURSOR_DEV_PLUGINS === '1' ||
	process.env.VITE_DISABLE_CURSOR_DEV_PLUGINS === 'true';
